...
return [
     ...
     */
    'title' => 'onlineprescribe API Document',
    ...
    'routes' => [
        [
             ...
             */
            'exclude' => [
                'sanctum/csrf-cookie', 'user', 'private', 'reservation-tl-stub', '/', 'reservation-tl-stub', 'temairazu/temairazu-reserve-stub', 'neppan/neppan-reserve-stub', 'rakutsu-stub', 'chillnn-stub', 'opcache-api/*', 'jal-member-callback',
            ],
